...
![Referral tracking dashboard showing metrics and customer data](https://9hvqwvm35snfqcsh.public.blob.vercel-storage.com/blog/referral-program-guide/inline-1.png)
...
![Customer receiving a thank-you gift for their referral](https://9hvqwvm35snfqcsh.public.blob.vercel-storage.com/blog/referral-program-guide/inline-2.png)
...
**Script the ask:**
"We grow almost entirely through referrals from happy customers. If you know anyone who might benefit from what we do, we'd love to take care of them—and you'd both receive [benefit]."
...
4. Close the loop with the referrer ("Thanks again for sending John—he's going to be a great fit")
...
Whether you need help implementing referral tracking software, automating your follow-up sequences, or building customer communication systems that drive loyalty, [let's talk about what's possible](/contact).
